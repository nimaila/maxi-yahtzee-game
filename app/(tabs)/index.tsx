      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
          <View className="flex-1 px-6 py-12 gap-12 items-center justify-center">
            {/* Logo and Title */}
            <Animated.View entering={FadeIn.duration(400)} className="items-center gap-6 mb-8">
              <Animated.View
            ...
            {/* Subtitle */}
            <Animated.View entering={SlideInDown.duration(400).delay(150)}>
            ...
            {/* Features */}
            <Animated.View entering={SlideInDown.duration(400).delay(300)} className="w-full gap-4 mt-8">
              <View
                style={{
